...
values."
  (setq-default
   ...
   '(
     ...
     yaml
     themes-megapack
     ;; async-shell - chris thing, not really sure wtf this is https://github.com/hh/async-shell-layer
     ;; (shell :variables
 ...
 '(safe-local-variable-values
   (quote
    ((eval setenv "PATH"
     ...
     (projectile-project-compilation-cmd . "docker exec -ti drunk_liskov /bin/bash -c 'cd /build ; ./runme'"))))
